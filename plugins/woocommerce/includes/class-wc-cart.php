...
class WC_Cart {
	...
	/*-----------------------------------------------------------------------------------*/
		...
		//	$cart_id        = $this->generate_cart_id( $product_id, $variation_id, $variation, $cart_item_data );
			...
			$cart_id        = $this->generate_cart_id( $product_id);
			...
			if ( $cart_item_key ) {
				...
				$new_quantity = $this->cart_contents[$cart_item_key]['quantity'];

				$this->set_quantity( $cart_item_key, $new_quantity, false,$cart_item_data );
		 ...
		 */
		public function set_quantity( $cart_item_key, $quantity = 1, $refresh_totals = true,$productdata="") {
			if ( $quantity == 0 || $quantity < 0 ) {
				...
				$this->cart_contents[ $cart_item_key ]['fpd_data'] = $productdata['fpd_data'];
