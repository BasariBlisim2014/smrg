			...
			<div id="order_data" class="panel">
				...
				<div class="order_data_column_container">
					<div class="order_data_column">
						...
						if(isset($only_quote) && $only_quote==1)
						{?>
						<p class="form-field form-field-wide">
						
							<button name="send_quote" id="send_quote">Send Quote</button>
							<label id="quote_notification"></label>
							<img src="<?php echo WC()->plugin_url(); ?>/assets/images/quote_loader.gif" height="35" width="35" style="display:none" id="quote_loader"/>
							...
							jQuery(document).ready(function($) {
								$("#send_quote").click(function(){
									...
									$.post(ajaxurl, data, function(response) {
										...
										$("#quote_loader").hide();
										$("#quote_notification").text("Quotation Sent.");
									});
									return false;
								});
