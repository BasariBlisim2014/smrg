...
$get_checkout_url = apply_filters( 'woocommerce_get_checkout_url', $woocommerce->cart->get_checkout_url() ); ?>
	...
	<?php if ( sizeof( $checkout->checkout_fields ) > 0 ) : ?>
		...
		<?php if ( is_user_logged_in() ) {
            ...
            echo '<p class="form-row form-row-last step-nav">
                <span class="pt-dark-button step-checkout" data-toggle="tab" data-show="billing" id="text_replacer">'.__('Continue to Billing Address', 'plumtree').'&nbsp;&nbsp;<i class="fa fa-angle-double-right"></i></span>
            </p>';
		    echo '</div>';
		...
		<?php do_action( 'woocommerce_checkout_before_customer_details' ); ?>
			...
			<div class="tab-pane active" id="authorization">
			    ...
			    <?php  echo '<p class="form-row form-row-last step-nav guest-step">
			                <span class="pt-dark-button step-checkout guest" data-toggle="tab" data-show="billing" id="text_replacer">'.__('Continue to Billing Address', 'plumtree').'&nbsp;&nbsp;<i class="fa fa-angle-double-right"></i></span>
			            </p>'; ?>
	...
	<form name="checkout" method="post" id="customer_details" class="checkout tab-content" action="<?php echo esc_url( $get_checkout_url ); ?>">
	...
	<div id="order_review_container" class="tab-pane">
...
<?php 
    		...
    		$current_user = wp_get_current_user();
				if(isset($_SESSION['only_quote']) && $_SESSION['only_quote']==1)
				{
				...
				?>
					<script language="javascript">
						...
						jQuery(document).ready(function($){
							...
							$("#text_replacer").click(function(){
								$("#billing_address").text("Fiyat Iste");
								$("#billing_address").removeAttr("data-toggle");
								$("#billing_address").removeClass("step-checkout");
							});
