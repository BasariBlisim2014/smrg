				...
				if ( ! empty( $available_gateways ) ) {
					...
					foreach ( $available_gateways as $gateway ) {
						if($gateway->id=='cod')
						{
							...
							{
								$available_gateways['cod']->set_current();
								?>
								<input id="payment_method_<?php echo $gateway->id; ?>" type="radio" class="input-radio" name="payment_method" value="<?php echo esc_attr( $gateway->id ); ?>" checked="checked" data-order_button_text="<?php echo esc_attr( $gateway->order_button_text ); ?>" />
								<?php
								break;
								//echo "here comdfesd";exit;
							}
							else{
							continue;
							}
